...
describe('createDeeplink', () => {
    it('should create a deeplink without action and payload', () => {
        const expected = 'signum.testdomain://v1';
    ...
    it('should create a deeplink with action but without payload', () => {
        const expected = 'signum.testdomain://v1?action=testAction';
        expect(createDeeplink({
            domain: 'testdomain',
            action: 'testAction',
        })).toBe(expected);
    ...
    it('should create a deeplink with action and payload - unencoded', () => {
        const expected = 'signum.testdomain://v1?action=testAction&payload=testPayload';
        expect(createDeeplink({
            domain: 'testdomain',
            action: 'testAction',
            payload: 'testPayload',
    ...
    it('should create a deeplink with action and payload - but no domain', () => {
        const expected = 'signum://v1?action=testAction&payload=testPayload';
        expect(createDeeplink({
            action: 'testAction',
            payload: 'testPayload',
            encoderFormat: EncoderFormat.Text
    ...
    it('should create a deeplink with action and payload - hex Encoded', () => {
        const expected = 'signum.testdomain://v1?action=testAction&payload=7b22666f6f223a22626172f09f9880222c22626172223a5b312c322c335d7d';
        expect(createDeeplink({
            domain: 'testdomain',
            action: 'testAction',
            payload: {
    ...
    it('should create a deeplink with action and payload - base64 Encoded', () => {
        const expected = 'signum.testdomain://v1?action=testAction&payload=eyJmb28iOiJiYXLwn5iAIiwiYmFyIjpbMSwyLDNdfQ';
        expect(createDeeplink({
            domain: 'testdomain',
            action: 'testAction',
            payload: {
