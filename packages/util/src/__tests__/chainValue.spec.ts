...
describe('ChainValue', () => {
    describe('creation', () => {
        it('Should create without problems', () => {
                const value = new ChainValue(0);
                const value2 = ChainValue.create(8);
                expect(value.getDecimals()).toBe(0)
                expect(value2.getDecimals()).toBe(8)
        });

        it('Should throw error on wrong decimals', () => {
            expect(() => {
                const bla = new ChainValue(9);
            }).toThrow();
    ...
    describe('setAtomic and getAtomic', () => {
        it('Should return value correctly', () => {
            const value = ChainValue.create(4);
        ...
        it('Should return no fractional atomic value ', () => {
            const value = ChainValue.create(2);
        ...
        it('Should throw error for invalid value', () => {
            expect(() => {
                ChainValue.create(2).setAtomic('');
            }).toThrow();
        });
        it('Should accept 0 decimals', () => {
            expect(ChainValue.create(0).setAtomic('100').getCompound()).toEqual('100');
        });
    });
    describe('setCompound and getCompound', () => {
        ...
        it('Should throw error for invalid value', () => {
            expect(() => {
                ChainValue.create(2).setCompound('test');
            }).toThrow();
            expect(() => {
                ChainValue.create(2).setCompound('12bf');
            }).toThrow();
        });
    });
    describe('getRaw', () => {
        it('Should return value correctly', () => {
            const value = ChainValue.create(8);
        ...
        it('Returned value should be immutable', () => {
            const value = ChainValue.create(8).setCompound(1);
    ...
    describe('equals', () => {
        it('should return true for value equality', () => {
            const amount1 = ChainValue.create(4).setCompound('10');
            const amount2 = ChainValue.create(4).setCompound('10');
            expect(amount1.equals(amount2)).toBeTruthy();
        });
        it('should return false for value inequality', () => {
            const amount1 = ChainValue.create(4).setCompound('10');
            const amount2 = ChainValue.create(4).setCompound('1');
            expect(amount1.equals(amount2)).toBeFalsy();
        });
    });
    describe('less', () => {
        it('should return true for lesser value', () => {
            const amount1 = ChainValue.create(4).setCompound('1');
            const amount2 = ChainValue.create(4).setCompound('10');
    ...
    describe('add', () => {
        ...
        it('should return correct sum multiple', () => {
            const amount1 = ChainValue.create(4).setCompound('10');
            const amount2 = ChainValue.create(4).setCompound('1.25');
    ...
    describe('clone', () => {
        it('should return cloned instance value', () => {
            const amount = ChainValue.create(4).setCompound('10');
            const cloned = amount.clone();
            amount.add(ChainValue.create(4).setCompound('10'));
