    ...
    return inquirer
        .prompt([
            ...
            },
            {
                type: 'input',
                name: 'amount',
                message: 'Please enter the amount you want to burn',
            },
            {
                type: 'list',
                name: 'feeType',
...
/**
 * This example shows how to burn tokens (which is actually just sending to 0 address)
 */
async function burnToken(args) {
    try {
        ...
        // SignumJS provides a comfort function `burnAsset`, which is the same as using `transferAsset` to recipient = 0
        ...
        console.info(`Burned ${amount} coins of Token ${name} - Transaction Id: ${transaction}`)
    } catch (e) {
